...
public class Elgamal
{
    public static void main(String[] args)
    {
        ...
        System.out.print("Enter the approximate value of the prime number for your El Gamal key: ");
        ...
        if (g != null)
        {
            ...
            k = k.mod(p);
            if (k.equals(BigInteger.ZERO) || k.equals(BigInteger.ONE)) k = k.add(new BigInteger("2"));
            ...
            System.out.print("Please enter your message. It should be in between 1 and "+ p + ": ");
